...
export const homeObjTwo = {
    ...
    lightTextDesc: true,
    topLine: 'Contact Us',
    headLine: 'Have a question? We can help.',
    description: 'For general queries, Contact At: help@wecarehomecare.com',
    buttonLabel: 'Complaint Request',
    imgStart: true,
    img: require('../../images/relax.svg').default,
    alt: 'ContactUs',
    dark: true,
    primary: true,
    darkText: false
